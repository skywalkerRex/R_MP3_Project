...
typedef struct {
  ...
  //new
  uint8_t slave_input_byte_pointer; 
  size_t slave_count;
} i2c_s;
...
static bool i2c__handle_state_machine(i2c_s *i2c) {
  ...
  case I2C__STATE_SR_SLAVE_1: //0x60
    i2c__set_ack_flag(lpc_i2c);
    i2c__clear_si_flag_for_hw_to_take_next_action(lpc_i2c);
    i2c->slave_count = 0;
    break;

  case I2C__STATE_SR_SLAVE_5: //0x80
  ...
  case I2C__STATE_SR_SLAVE_7: //0x90
    i2c->slave_input_byte_pointer = lpc_i2c->DAT;
    lpc_i2c->CONCLR = 0x0C;
    break;

  // Slave Trasmitted Mode
  case I2C__STATE_ST_SLAVE_1: //A8
  ...
  case I2C__STATE_SR_SLAVE_9: //A0
  case I2C__STATE_ST_SLAVE_4: //C0
    i2c__set_ack_flag(lpc_i2c);
    i2c__clear_si_flag_for_hw_to_take_next_action(lpc_i2c);
    break;
