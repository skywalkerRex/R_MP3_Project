...
typedef struct {
  ...
  uint8_t slave_input_byte_pointer; ///< Used for reading I2C master device
  size_t slave_count;
...
bool i2c__write_no_addr(i2c_e i2c_number, uint8_t slave_address, uint8_t slave_memory_address) {
  uint8_t value = 0;
  return i2c__write_slave_data(i2c_number, slave_address, slave_memory_address, &value, -1);
}
...
static bool i2c__handle_state_machine(i2c_s *i2c) {
  enum {
    ...
    I2C__STATE_SR_SLAVE_1 = 0x60,
    I2C__STATE_SR_SLAVE_2 = 0x68,
    I2C__STATE_SR_SLAVE_3 = 0x70,
    I2C__STATE_SR_SLAVE_4 = 0x78,
    I2C__STATE_SR_SLAVE_5 = 0x80,
    I2C__STATE_SR_SLAVE_6 = 0x88,
    I2C__STATE_SR_SLAVE_7 = 0x90,
    I2C__STATE_SR_SLAVE_8 = 0x98,
    I2C__STATE_SR_SLAVE_9 = 0xA0,

    // Slave Transmitter States (ST):
    I2C__STATE_ST_SLAVE_1 = 0xA8,
    I2C__STATE_ST_SLAVE_2 = 0xB0,
    I2C__STATE_ST_SLAVE_3 = 0xB8,
    I2C__STATE_ST_SLAVE_4 = 0xC0,
    I2C__STATE_ST_SLAVE_5 = 0xC8,
  };
  ...
  case I2C__STATE_SR_SLAVE_1:
  case I2C__STATE_SR_SLAVE_3:
    i2c__set_ack_flag(lpc_i2c);
    i2c__clear_si_flag_for_hw_to_take_next_action(lpc_i2c);
    i2c->slave_count = 0;
    break;

  case I2C__STATE_SR_SLAVE_2:
  case I2C__STATE_SR_SLAVE_4:
    lpc_i2c->CONSET = 0x24;
    i2c__clear_si_flag_for_hw_to_take_next_action(lpc_i2c);
    i2c->slave_count = 0;
    break;

  case I2C__STATE_SR_SLAVE_5:
  ...
  case I2C__STATE_SR_SLAVE_6:
  case I2C__STATE_SR_SLAVE_8:
  case I2C__STATE_SR_SLAVE_9:
  case I2C__STATE_ST_SLAVE_4:
  case I2C__STATE_ST_SLAVE_5:
    i2c__set_ack_flag(lpc_i2c);
    i2c__clear_si_flag_for_hw_to_take_next_action(lpc_i2c);
    break;

  case I2C__STATE_SR_SLAVE_7:
    i2c->slave_input_byte_pointer = lpc_i2c->DAT;
    lpc_i2c->CONCLR = 0x0C;
    break;

  // Slave Trasmitted Mode
  case I2C__STATE_ST_SLAVE_1:
