...
void sj2_cli__init(void) {
  ...
  static app_cli__command_s task_ctl = {.command_name = "taskctl",
                                        .help_message_for_command = "Suspend or Resume a Task.\n"
                                                                    "task suspend <taskname>' will suspend that task.\n"
                                                                    "task resume <taskname>' will resume that task.",
                                        .app_cli_handler = cli__task_ctl};
  static app_cli__command_s play = {.command_name = "Play",
                                    .help_message_for_command =
                                        "Play a mp3 music from SD Card.\n"
  ...
  app_cli__add_command_handler(&sj2_cli_struct, &task_ctl);
