...
static void cli__i2c_read(const sl_string_s command_params, app_cli__print_string_function cli_output);
static void cli__i2c_write(sl_string_s command_params, app_cli__print_string_function cli_output);

app_cli_status_e cli__i2c(app_cli__argument_t argument, sl_string_s user_input_minus_command_name,
  ...
  // const bool discov = sl_string__begins_with_ignore_case(user_input_minus_command_name, "discover");
...
static void cli__i2c_read(const sl_string_s command_params, app_cli__print_string_function cli_output) {
  ...
  sl_string_s output = sl_string__initialize(string_memory, sizeof(string_memory));
